...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/power_transform_impl.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/power_transform_impl.py).
