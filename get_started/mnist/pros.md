...
[introduction for beginners](../../get_started/mnist/beginners.md). Be sure to
[install TensorFlow](../../install/index.md) before starting.*
...
[computation graph](../../get_started/get_started.md#the_computational_graph)
...
[launching the graph](../../get_started/get_started.md#the_computational_graph).
...
the [Computation Graph](../../get_started/get_started.md#the_computational_graph)
section of [Getting Started With TensorFlow](../../get_started/get_started.md) for more detail.
...
[built-in optimization algorithms](../../api_guides/python/train.md#optimizers).
