...
the [API documentation](../api_docs/python/tfdbg/DebugDumpDir.md#find)
...
[`fit()`](../api_docs/python/tf/contrib/learn/BaseEstimator.md#fit)
[`evaluate()`](../api_docs/python/tf/contrib/learn/BaseEstimator.md#evaluate)
...
[this API doc](../api_docs/python/tfdbg/DumpingDebugWrapperSession.md#__init__)
for more details.
...
with, by using the method [`tfdbg.watch_graph`](../api_docs/python/tfdbg/watch_graph.md).
...
*   many [`tf.while_loop`](../api_docs/python/tf/while_loop.md) iterations
...
**A**: The reason why you see no data dumped is because every node in the
       ...
       [`tf.Variable`](../api_docs/python/tf/Variable.md), as in the following example:
