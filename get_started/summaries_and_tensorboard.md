...
attaching [`tf.summary.scalar`](../api_docs/python/tf/summary/scalar.md) ops
...
[`tf.summary.histogram`](../api_docs/python/tf/summary/histogram.md) ops to
...
[`tf.summary.merge_all`](../api_docs/python/tf/summary/merge_all.md)
...
[Tensor shape information](../get_started/graph_viz.md#tensor-shape-information).
...
[simple MNIST tutorial](../get_started/mnist/beginners.md),
...
see [TensorBoard: Graph Visualization](../get_started/graph_viz.md).
