...
familiar with the [basic concepts](../get_started/get_started.md) of
...
The
[`tf.train.Server.create_local_server`](../api_docs/python/tf/train/Server.md#create_local_server)
...
the [`tf.train.ClusterSpec`](../api_docs/python/tf/train/ClusterSpec.md)
...
A [`tf.train.Server`](../api_docs/python/tf/train/Server.md) object contains a
set of local devices, a set of connections to other tasks in its
`tf.train.ClusterSpec`, and a
[`tf.Session`](../api_docs/python/tf/Session.md) that can use these
...
[`tf.device`](../api_docs/python/tf/device.md)
...
* **Synchronous training.** In this approach, all of the replicas read the same
  ...
  [`tf.train.SyncReplicasOptimizer`](../api_docs/python/tf/train/SyncReplicasOptimizer.md)).
...
a [`tf.train.ClusterSpec`](../api_docs/python/tf/train/ClusterSpec.md) object.
...
a [`tf.train.Server`](../api_docs/python/tf/train/Server.md) instance, which is
