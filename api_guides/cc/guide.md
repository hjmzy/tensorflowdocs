...
[`tensorflow::Scope`](../../api_docs/cc/class/tensorflow/scope.md) is the main data structure that holds the current state
...
[`tensorflow::Status`](../../api_docs/cc/class/tensorflow/status.md) object which will be used to indicate errors encountered
...
Please refer to [`tensorflow::Scope`](../../api_docs/cc/class/tensorflow/scope.md) for the complete list of member functions
...
[`tensorflow::ops::Const`](../../api_docs/cc/namespace/tensorflow/ops.md#const) function from various kinds of C++ values. For
example:
...
[`tensorflow::ClientSession`](../../api_docs/cc/class/tensorflow/client-session.md) class that will execute ops created by the
...
Please see the [`tensorflow::Tensor`](../../api_docs/cc/class/tensorflow/tensor.md) documentation for more information on how
