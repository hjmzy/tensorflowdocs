...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/inline_impl.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/inline_impl.py).
