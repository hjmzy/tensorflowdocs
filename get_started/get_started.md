...
[install TensorFlow](../install/index.md). To get the most out of
...
machine learning see [MNIST for beginners](../get_started/mnist/beginners.md),
otherwise see [Deep MNIST for experts](../get_started/mnist/pros.md).
