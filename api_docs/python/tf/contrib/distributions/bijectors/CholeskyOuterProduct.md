...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product_impl.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product_impl.py).
