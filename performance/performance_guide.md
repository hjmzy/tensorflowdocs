...
The [Dataset API](../programmers_guide/datasets.md) is replacing `queue_runner` as the recommended API
...
[`tf.layers.batch_normalization`](../api_docs/python/tf/layers/batch_normalization.md) added fused starting in TensorFlow 1.3.
...
The contrib [`tf.contrib.layers.batch_norm`](../api_docs/python/tf/contrib/layers/batch_norm.md) method has had fused as an option
