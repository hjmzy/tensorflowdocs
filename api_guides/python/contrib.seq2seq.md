...
libraries in [`tf.contrib.rnn`](../../api_docs/python/tf/contrib/rnn.md).

This library is composed of two primary components:

*   New attention wrappers for [`tf.contrib.rnn.RNNCell`](../../api_docs/python/tf/contrib/rnn/RNNCell.md) objects.
...
[`tf.contrib.seq2seq.AttentionMechanism`](../../api_docs/python/tf/contrib/seq2seq/AttentionMechanism.md).  These subclasses describe the form
...
*   [`tf.contrib.seq2seq.BahdanauAttention`](../../api_docs/python/tf/contrib/seq2seq/BahdanauAttention.md) (additive attention,
    [ref.](https://arxiv.org/abs/1409.0473))
*   [`tf.contrib.seq2seq.LuongAttention`](../../api_docs/python/tf/contrib/seq2seq/LuongAttention.md) (multiplicative attention,
...
The basic attention wrapper is [`tf.contrib.seq2seq.AttentionWrapper`](../../api_docs/python/tf/contrib/seq2seq/AttentionWrapper.md).
...
*   [`tf.contrib.seq2seq.Decoder`](../../api_docs/python/tf/contrib/seq2seq/Decoder.md)
*   [`tf.contrib.seq2seq.dynamic_decode`](../../api_docs/python/tf/contrib/seq2seq/dynamic_decode.md)

### Basic Decoder
*   [`tf.contrib.seq2seq.BasicDecoderOutput`](../../api_docs/python/tf/contrib/seq2seq/BasicDecoderOutput.md)
*   [`tf.contrib.seq2seq.BasicDecoder`](../../api_docs/python/tf/contrib/seq2seq/BasicDecoder.md)

### Decoder Helpers
*   [`tf.contrib.seq2seq.Helper`](../../api_docs/python/tf/contrib/seq2seq/Helper.md)
*   [`tf.contrib.seq2seq.CustomHelper`](../../api_docs/python/tf/contrib/seq2seq/CustomHelper.md)
*   [`tf.contrib.seq2seq.GreedyEmbeddingHelper`](../../api_docs/python/tf/contrib/seq2seq/GreedyEmbeddingHelper.md)
*   [`tf.contrib.seq2seq.ScheduledEmbeddingTrainingHelper`](../../api_docs/python/tf/contrib/seq2seq/ScheduledEmbeddingTrainingHelper.md)
*   [`tf.contrib.seq2seq.ScheduledOutputTrainingHelper`](../../api_docs/python/tf/contrib/seq2seq/ScheduledOutputTrainingHelper.md)
*   [`tf.contrib.seq2seq.TrainingHelper`](../../api_docs/python/tf/contrib/seq2seq/TrainingHelper.md)
