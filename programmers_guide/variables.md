...
variable. For this reason we provide [`tf.train.replica_device_setter`](../api_docs/python/tf/train/replica_device_setter.md), which
...
[`tf.train.Optimizer`](../api_docs/python/tf/train/Optimizer.md) for an explanation of how to use optimizers.
