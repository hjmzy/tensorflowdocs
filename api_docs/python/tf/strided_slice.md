...
**Most users will want to use [`tf.Tensor.__getitem__`](../tf/Tensor.md#__getitem__) and
[`tf.Variable.__getitem__`](../tf/Variable.md#__getitem__).** That allows  NumPy style slicing syntax (i.e.
