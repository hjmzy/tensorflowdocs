...
Defined in [`tensorflow/python/keras/_impl/keras/layers/advanced_activations.py`](https://www.tensorflow.org/code/tensorflow/python/keras/_impl/keras/layers/advanced_activations.py).
