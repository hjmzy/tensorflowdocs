...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/affine_linear_operator_impl.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/affine_linear_operator_impl.py).
