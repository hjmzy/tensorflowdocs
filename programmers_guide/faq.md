...
into a numpy array. Then use [`tf.data.Dataset.from_tensor_slices`](../api_docs/python/tf/data/Dataset.md#from_tensor_slices) to
...
[`tf.data.TextLineDataset`](../api_docs/python/tf/data/TextLineDataset.md). Then convert the dataset by mapping
[mapping](../api_docs/python/tf/data/Dataset.md#map) appropriate operations over it.
