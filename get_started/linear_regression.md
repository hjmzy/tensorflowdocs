...
<table>
  ...
  <tr>
    ...
    <td>Use the [`tf.estimator.LinearRegressor`](../api_docs/python/tf/estimator/LinearRegressor.md) Estimator to train a
  ...
  <tr>
    ...
    <td>[imports85](https://archive.ics.uci.edu/ml/datasets/automobile)</td>
    <td>Use the [`tf.estimator.DNNRegressor`](../api_docs/python/tf/estimator/DNNRegressor.md) Estimator to train a
  ...
  <tr>
    ...
    <td>[imports85](https://archive.ics.uci.edu/ml/datasets/automobile)</td>
    <td>Use [`tf.estimator.Estimator`](../api_docs/python/tf/estimator/Estimator.md) to train a customized dnn
        regression model.</td>
  </tr>
...
a custom model using the base [`Estimator`](../api_docs/python/tf/estimator/Estimator.md) class. The
...
[`EstimatorSpec`](../api_docs/python/tf/estimator/EstimatorSpec.md) which is a simple structure
