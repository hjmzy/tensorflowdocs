...
and sessions. See [Getting Started](../get_started/get_started.md)
for an introduction to these topics. Some familiarity
with [distributed TensorFlow](../deploy/distributed.md)
...
distributed master as a [`tf.GraphDef`](../api_docs/python/tf/GraphDef.md)
...
*  [`tf.Session`](../api_docs/python/tf/Session.md)
