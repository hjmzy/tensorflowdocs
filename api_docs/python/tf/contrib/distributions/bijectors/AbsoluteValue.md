...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/absolute_value_impl.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/absolute_value_impl.py).
