...
be useful to you. Then do the [Linear Models tutorial](../tutorials/wide.md) to
...
with basic machine learning concepts, and also with [tf.estimator](../get_started/estimator.md).
...
[Building Input Functions with tf.estimator](../get_started/input_fn.md) for a
...
```
For more information, see the [Wide and Deep Learning tutorial](../tutorials/wide_and_deep.md).
