...
See the [Variables How To](../../../programmers_guide/variables.md) for a high level overview.
...
passed, the default session is used.  See [`tf.Session`](../tf/Session.md) for more
