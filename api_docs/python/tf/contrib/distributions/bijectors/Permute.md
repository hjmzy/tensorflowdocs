...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/permute_impl.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bijectors/permute_impl.py).
