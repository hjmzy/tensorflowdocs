...
[faster paced tutorial](../../get_started/mnist/pros.md).  Be sure to
[install TensorFlow](../../install/index.md) before starting either
tutorial.*
...
[many other optimization algorithms](../../api_guides/python/train.md#Optimizers):
...
[the next tutorial](../../get_started/mnist/pros.md) where we do a lot
