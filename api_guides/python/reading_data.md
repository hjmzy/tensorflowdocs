...
[Datasets API](../../programmers_guide/datasets.md).
...
[`tf.placeholder`](../../api_docs/python/tf/placeholder.md) node. A
...
and is described in the [MNIST tutorial](../../get_started/mnist/mechanics.md).

<h2 id="Reading_from_files">Reading from files</h2>
...
queue-based APIs which can be cleanly replaced by the [Datasets API](../../programmers_guide/datasets.md).

### Filenames, shuffling, and epoch limits

For the list of filenames, use either a constant string Tensor (like
`["file0", "file1"]` or `[("file%d" % i) for i in range(2)]`) or the
[`tf.train.match_filenames_once`](../../api_docs/python/tf/train/match_filenames_once.md) function.

Pass the list of filenames to the [`tf.train.string_input_producer`](../../api_docs/python/tf/train/string_input_producer.md) function.
...
[`tf.TextLineReader`](../../api_docs/python/tf/TextLineReader.md) with the
[`tf.decode_csv`](../../api_docs/python/tf/decode_csv.md) operation. For example:
...
with the [`tf.decode_raw`](../../api_docs/python/tf/decode_raw.md) operation.
...
and described in
[this tutorial](../../tutorials/deep_cnn.md#prepare-the-data).
...
[`tf.TFRecordReader`](../../api_docs/python/tf/TFRecordReader.md) with
the [`tf.parse_single_example`](../../api_docs/python/tf/parse_single_example.md)
...
[view your summaries as training progresses using TensorBoard](../../get_started/summaries_and_tensorboard.md).

### Creating threads to prefetch using `QueueRunner` objects

The short version: many of the `tf.train` functions listed above add
[`tf.train.QueueRunner`](../../api_docs/python/tf/train/QueueRunner.md) objects to your
...
[`tf.train.Coordinator`](../../api_docs/python/tf/train/Coordinator.md) to cleanly
...
a [`tf.train.QueueRunner`](../../api_docs/python/tf/train/QueueRunner.md) to the
graph using the
...
[`tf.errors.OutOfRangeError`](../../api_docs/python/tf/errors/OutOfRangeError.md). This
...
[`tf.train.Coordinator`](../../api_docs/python/tf/train/Coordinator.md). This is responsible
...
[`tf.RandomShuffleQueue`](../../api_docs/python/tf/RandomShuffleQueue.md), say
...
[`tf.train.Coordinator.join`](../../api_docs/python/tf/train/Coordinator.md#join)
...
[`tf.parse_example`](../../api_docs/python/tf/parse_example.md) **after**
...
[`tf.train.batch`](../../api_docs/python/tf/train/batch.md) function.  To use
...
This is what is done [estimators](../../api_docs/python/tf/estimator.md) and manually in
[the example CIFAR-10 model](../../tutorials/deep_cnn.md#save-and-restore-checkpoints).
...
their trained variables or layers. See [the shared variables tutorial](../../programmers_guide/variables.md).

To support the single-graph approach
[Datasets](../../programmers_guide/datasets.md) also supplies
[advanced iterator types](../../programmers_guide/datasets.md#creating_an_iterator) that
...
operations (like [`tf.layers.batch_normalization`](../../api_docs/python/tf/layers/batch_normalization.md), and [`tf.layers.dropout`](../../api_docs/python/tf/layers/dropout.md))
