...
2.  Construct a [neural network classifier](../api_docs/python/tf/estimator/DNNClassifier.md)
3.  Train the model using the training data
4.  Evaluate the accuracy of the model
5.  Classify new samples

NOTE: Remember to [install TensorFlow on your machine](../install/index.md)
...
[`tf.estimator.DNNClassifier`](../api_docs/python/tf/estimator/DNNClassifier.md) with just a couple lines of code:
...
Iris training data using the [`train`](../api_docs/python/tf/estimator/Estimator.md#train) method.
...
want to instead use a TensorFlow [`SessionRunHook`](../api_docs/python/tf/train/SessionRunHook.md)
...
[`evaluate`](../api_docs/python/tf/estimator/Estimator.md#evaluate) method. Like `train`,
...
*   To learn more about using tf.estimator to create linear models, see
    [Large-scale Linear Models with TensorFlow](../tutorials/linear.md).

*   To build your own Estimator using tf.estimator APIs, check out
    [Creating Estimators in tf.estimator](../extend/estimators.md).
...
*   For more advanced tutorials on neural networks, see
    [Convolutional Neural Networks](../tutorials/deep_cnn.md) and [Recurrent Neural
    Networks](../tutorials/recurrent.md).
