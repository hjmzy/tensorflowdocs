...
Defined in [`tensorflow/python/keras/_impl/keras/layers/embeddings.py`](https://www.tensorflow.org/code/tensorflow/python/keras/_impl/keras/layers/embeddings.py).
