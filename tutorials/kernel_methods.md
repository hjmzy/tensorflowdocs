...
[Building Input Functions with tf.contrib.learn](../get_started/input_fn.md). In this
...
[`tf.contrib.learn.LinearClassifier`](../api_docs/python/tf/contrib/learn/LinearClassifier.md) estimator with 10 classes representing the
...
### Kernel classifier
[`tf.contrib.kernel_methods.KernelLinearClassifier`](../api_docs/python/tf/contrib/kernel_methods/KernelLinearClassifier.md) is a pre-packaged
