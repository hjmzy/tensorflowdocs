...
The `placeholder_inputs()` function creates two [`tf.placeholder`](../../api_docs/python/tf/placeholder.md)
...
Each layer is created beneath a unique [`tf.name_scope`](../../api_docs/python/tf/name_scope.md)
...
layers are generated into [`tf.Variable`](../../api_docs/python/tf/Variable.md)
...
Then the biases are initialized with [`tf.zeros`](../../api_docs/python/tf/zeros.md)
...
The graph's three primary ops -- two [`tf.nn.relu`](../../api_docs/python/tf/nn/relu.md)
ops wrapping [`tf.matmul`](../../api_docs/python/tf/matmul.md)
...
First, the values from the `labels_placeholder` are converted to 64-bit integers. Then, a [`tf.nn.sparse_softmax_cross_entropy_with_logits`](../../api_docs/python/tf/nn/sparse_softmax_cross_entropy_with_logits.md) op is added to automatically produce 1-hot labels from the `labels_placeholder` and compare the output logits from the `inference()` function with those 1-hot labels.
...
It then uses [`tf.reduce_mean`](../../api_docs/python/tf/reduce_mean.md)
...
[`tf.summary.scalar`](../../api_docs/python/tf/summary/scalar.md),
an op for generating summary values into the events file when used with a
[`tf.summary.FileWriter`](../../api_docs/python/tf/summary/FileWriter.md) (see below).  In this case, it will emit the snapshot value of
...
Next, we instantiate a [`tf.train.GradientDescentOptimizer`](../../api_docs/python/tf/train/GradientDescentOptimizer.md)
...
training step and the [`tf.train.Optimizer.minimize`](../../api_docs/python/tf/train/Optimizer.md#minimize)
...
global [`tf.Graph`](../../api_docs/python/tf/Graph.md)
instance.
...
ops generated, a [`tf.Session`](../../api_docs/python/tf/Session.md)
...
instances are initialized by calling [`tf.Session.run`](../../api_docs/python/tf/Session.md#run)
...
The [`tf.Session.run`](../../api_docs/python/tf/Session.md#run)
...
op is a [`tf.group`](../../api_docs/python/tf/group.md)
...
In order to emit the events files used by [TensorBoard](../../get_started/summaries_and_tensorboard.md),
...
And then after the session is created, a [`tf.summary.FileWriter`](../../api_docs/python/tf/summary/FileWriter.md)
...
**NOTE**: For more info about how to build and run Tensorboard, please see the accompanying tutorial [Tensorboard: Visualizing Learning](../../get_started/summaries_and_tensorboard.md).
...
In the training loop, the [`tf.train.Saver.save`](../../api_docs/python/tf/train/Saver.md#save)
...
[`tf.train.Saver.restore`](../../api_docs/python/tf/train/Saver.md#restore)
...
The `evaluation()` function simply generates a [`tf.nn.in_top_k`](../../api_docs/python/tf/nn/in_top_k.md)
