...
This document introduces [**Estimators**](../api_docs/python/tf/estimator.md)--a high-level TensorFlow
...
classes based on the [`tf.estimator.Estimator`](../api_docs/python/tf/estimator/Estimator.md) class.

Note: TensorFlow also includes a deprecated `Estimator` class at
[`tf.contrib.learn.Estimator`](../api_docs/python/tf/contrib/learn/Estimator.md), which you should not use.
...
[`Graph`](../api_docs/python/tf/Graph.md) and [`Session`](../api_docs/python/tf/Session.md) objects for you.  Furthermore,
pre-made Estimators let you experiment with different model architectures by
making only minimal code changes.  [`DNNClassifier`](../api_docs/python/tf/estimator/DNNClassifier.md),
...
1.  **Write one or more dataset importing functions.** For example, you might
    ...
    *   a Tensor containing one or more labels
    ...
    (See [Importing Data](../programmers_guide/datasets.md) for full details.)
...
[`tf.keras.estimator.model_to_estimator`](../api_docs/python/tf/keras/estimator/model_to_estimator.md) as in the
following sample:
...
[`tf.keras.estimator.model_to_estimator`](../api_docs/python/tf/keras/estimator/model_to_estimator.md).
