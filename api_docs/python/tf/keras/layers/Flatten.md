...
Inherits From: [`Flatten`](../../../tf/layers/Flatten.md), [`Layer`](../../../tf/keras/layers/Layer.md)



Defined in [`tensorflow/python/keras/_impl/keras/layers/core.py`](https://www.tensorflow.org/code/tensorflow/python/keras/_impl/keras/layers/core.py).
