...
TensorFlow with GPU support, but only if you do the following:
  ...
  * Install TensorFlow from sources as documented in
    [Installing TensorFlow from Sources](../install/install_sources.md).
...
If you are new to TensorFlow, see [Getting Started with TensorFlow](../get_started/get_started.md).
