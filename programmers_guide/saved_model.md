...
[variables](../programmers_guide/variables.md) and models.


## Saving and restoring variables

A TensorFlow variable provides the best way to represent shared, persistent
state manipulated by your program. (See [Variables](../programmers_guide/variables.md) for details.)
...
*  If you only restore a subset of the model variables at the start of a
   ...
   [`tf.variables_initializer`](../api_docs/python/tf/variables_initializer.md) for more information.
...
*  By default, `Saver` uses the value of the [`tf.Variable.name`](../api_docs/python/tf/Variable.md#name) property
...
[builder](../api_docs/python/tf/saved_model/builder.md).
...
[loader](../api_docs/python/tf/saved_model/loader.md)
...
During training, an [`input_fn()`](../get_started/input_fn.md) ingests data and prepares it for
...
The function returns a [`tf.estimator.export.ServingInputReceiver`](../api_docs/python/tf/estimator/export/ServingInputReceiver.md) object,
...
responsible for parsing the `tf.Example`s by adding a [`tf.parse_example`](../api_docs/python/tf/parse_example.md) op to
the graph.

When writing such a `serving_input_receiver_fn()`, you must pass a parsing
specification to [`tf.parse_example`](../api_docs/python/tf/parse_example.md) to tell the parser what feature names to
expect and how to map them to `Tensor`s. A parsing specification takes the
form of a dict from feature names to [`tf.FixedLenFeature`](../api_docs/python/tf/FixedLenFeature.md), [`tf.VarLenFeature`](../api_docs/python/tf/VarLenFeature.md),
and [`tf.SparseFeature`](../api_docs/python/tf/SparseFeature.md).  Note this parsing specification should not include
...
The [`tf.estimator.export.build_parsing_serving_input_receiver_fn`](../api_docs/python/tf/estimator/export/build_parsing_serving_input_receiver_fn.md) utility
...
[`tf.estimator.export.build_raw_serving_input_receiver_fn`](../api_docs/python/tf/estimator/export/build_raw_serving_input_receiver_fn.md) utility provides for
this.
...
[`tf.estimator.Estimator.export_savedmodel`](../api_docs/python/tf/estimator/Estimator.md#export_savedmodel) with the export base path and
...
of the [`tf.estimator.EstimatorSpec`](../api_docs/python/tf/estimator/EstimatorSpec.md) return value. This is a dict of
...
[`tf.estimator.export.ClassificationOutput`](../api_docs/python/tf/estimator/export/ClassificationOutput.md),
[`tf.estimator.export.RegressionOutput`](../api_docs/python/tf/estimator/export/RegressionOutput.md), or
[`tf.estimator.export.PredictOutput`](../api_docs/python/tf/estimator/export/PredictOutput.md).
...
[Tensor dtype and shape](../programmers_guide/tensors.md) match the model. Moreover, if you
