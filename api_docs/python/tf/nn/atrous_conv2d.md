...
[`tf.nn.convolution`](../../tf/nn/convolution.md), and exists only for backwards compatibility. You can
use [`tf.nn.convolution`](../../tf/nn/convolution.md) to perform 1-D, 2-D, or 3-D atrous convolution.
