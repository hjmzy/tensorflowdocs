...
See the guides: [Inputs and Readers > Queues](../../../api_guides/python/io_ops.md#Queues), [Reading data > Reading from files](../../../api_guides/python/reading_data.md#Reading_from_files), [Threading and Queues > Queue usage overview](../../../api_guides/python/threading_and_queues.md#Queue_usage_overview)

A queue implementation that dequeues elements in a random order.

See [`tf.QueueBase`](../tf/QueueBase.md) for a description of the methods on
this class.
...
[`tf.QueueBase.close`](../tf/QueueBase.md#close) before or during its execution. If the
queue is closed, the queue is empty, and there are no pending
enqueue operations that can fulfill this request,
`tf.errors.OutOfRangeError` will be raised. If the session is
[`tf.Session.close`](../tf/Session.md#close),
...
session is [`tf.Session.close`](../tf/Session.md#close),
`tf.errors.CancelledError` will be raised.
...
`tf.errors.OutOfRangeError` like [`tf.QueueBase.dequeue_many`](../tf/QueueBase.md#dequeue_many),
