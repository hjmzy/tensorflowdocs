...
```C++
  ...
  return Status::OK();
```
Then we create a [`tf.Session`](../api_docs/python/tf/Session.md)
...
There's a guide to doing this [in the how-to section](../tutorials/image_retraining.md).
...
to the TensorFlow [deep convolutional networks tutorial](../tutorials/deep_cnn.md),
or start a bit more gently with our
[ML beginner](../get_started/mnist/beginners.md) or [ML expert](../get_started/mnist/pros.md)
