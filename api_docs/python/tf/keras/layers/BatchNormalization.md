...
Inherits From: [`BatchNormalization`](../../../tf/layers/BatchNormalization.md), [`Layer`](../../../tf/keras/layers/Layer.md)



Defined in [`tensorflow/python/keras/_impl/keras/layers/normalization.py`](https://www.tensorflow.org/code/tensorflow/python/keras/_impl/keras/layers/normalization.py).
