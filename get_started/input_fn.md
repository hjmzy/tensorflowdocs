...
Here's an example taken from the [tf.estimator Quickstart tutorial](../get_started/estimator.md):
...
For more on `SparseTensor`, see [`tf.SparseTensor`](../api_docs/python/tf/SparseTensor.md).
...
([`tf.train`](../api_docs/python/tf/train.md),
[`tf.test`](../api_docs/python/tf/test.md), and
...
[this introduction](../tutorials/linear.md#feature-columns-and-transformations),
and for an example that illustrates how to define `FeatureColumns` for
categorical data, see the [Linear Model Tutorial](../tutorials/wide.md).
...
*   [Large-scale Linear Models with TensorFlow](../tutorials/linear.md): This
...
*   [TensorFlow Linear Model Tutorial](../tutorials/wide.md): This tutorial covers
...
*   [TensorFlow Wide & Deep Learning Tutorial](../tutorials/wide_and_deep.md): Building on
    the [Linear Model Tutorial](../tutorials/wide.md), this tutorial covers
