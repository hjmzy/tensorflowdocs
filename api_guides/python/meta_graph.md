...
the [`tf.train.Saver`](../../api_docs/python/tf/train/Saver.md) class:
...
[`tf.train.QueueRunner`](../../api_docs/python/tf/train/QueueRunner.md), etc.  In order for a Python object to be serialized
