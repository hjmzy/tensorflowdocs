...
[a Reader for text files](../api_docs/python/tf/TextLineReader.md)
followed by
[an Op that parses CSV data from a line of text](../api_docs/python/tf/decode_csv.md).
...
3.  In Python, define a subclass of [`tf.ReaderBase`](../api_docs/python/tf/ReaderBase.md) called `SomeReader`.
...
with [the adding an op how-to](../extend/adding_an_op.md).  The main steps
are:
...
[compiling a dynamic library](../extend/adding_an_op.md#building_the_op_library)
...
from a
[`tf.parse_single_example`](../api_docs/python/tf/parse_single_example.md)
op and call [`tf.image.decode_jpeg`](../api_docs/python/tf/image/decode_jpeg.md),
[`tf.image.decode_png`](../api_docs/python/tf/image/decode_png.md), or
[`tf.decode_raw`](../api_docs/python/tf/decode_raw.md).  It is common to
take the output of `tf.decode_raw` and use
[`tf.slice`](../api_docs/python/tf/slice.md) and
[`tf.reshape`](../api_docs/python/tf/reshape.md) to extract pieces.
