...
Defined in [`tensorflow/python/keras/_impl/keras/layers/convolutional_recurrent.py`](https://www.tensorflow.org/code/tensorflow/python/keras/_impl/keras/layers/convolutional_recurrent.py).
