...
* Core mathematical components including [convolution](../api_docs/python/tf/nn/conv2d.md)
([wiki](https://en.wikipedia.org/wiki/Convolution)),
[rectified linear activations](../api_docs/python/tf/nn/relu.md)
([wiki](https://en.wikipedia.org/wiki/Rectifier_(neural_networks))),
[max pooling](../api_docs/python/tf/nn/max_pool.md)
([wiki](https://en.wikipedia.org/wiki/Convolutional_neural_network#Pooling_layer))
and [local response normalization](../api_docs/python/tf/nn/local_response_normalization.md)
(Chapter 3.3 in
[AlexNet paper](https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks.pdf)).
* [Visualization](../get_started/summaries_and_tensorboard.md)
...
[moving average](../api_docs/python/tf/train/ExponentialMovingAverage.md)
of learned parameters and using these averages
during evaluation to boost predictive performance.
* Implementation of a
[learning rate schedule](../api_docs/python/tf/train/exponential_decay.md)
that systematically decrements over time.
* Prefetching [queues](../api_docs/python/tf/train/shuffle_batch.md)
for input
...
*  They are cropped to 24 x 24 pixels, centrally for evaluation or
   [randomly](../api_docs/python/tf/random_crop.md) for training.
*  They are [approximately whitened](../api_docs/python/tf/image/per_image_standardization.md)
   to make the model insensitive to dynamic range.

For training, we additionally apply a series of random distortions to
artificially increase the data set size:

* [Randomly flip](../api_docs/python/tf/image/random_flip_left_right.md) the image from left to right.
* Randomly distort the [image brightness](../api_docs/python/tf/image/random_brightness.md).
* Randomly distort the [image contrast](../api_docs/python/tf/image/random_contrast.md).

Please see the [Images](../api_guides/python/image.md) page for the list of
available distortions. We also attach an
[`tf.summary.image`](../api_docs/python/tf/summary/image.md) to the images
so that we may visualize them in [TensorBoard](../get_started/summaries_and_tensorboard.md).
...
[queue](../api_docs/python/tf/train/shuffle_batch.md).
...
--- | ---
`conv1` | [convolution](../api_docs/python/tf/nn/conv2d.md) and [rectified linear](../api_docs/python/tf/nn/relu.md) activation.
`pool1` | [max pooling](../api_docs/python/tf/nn/max_pool.md).
`norm1` | [local response normalization](../api_docs/python/tf/nn/local_response_normalization.md).
`conv2` | [convolution](../api_docs/python/tf/nn/conv2d.md) and [rectified linear](../api_docs/python/tf/nn/relu.md) activation.
`norm2` | [local response normalization](../api_docs/python/tf/nn/local_response_normalization.md).
`pool2` | [max pooling](../api_docs/python/tf/nn/max_pool.md).
...
[softmax](../api_docs/python/tf/nn/softmax.md) nonlinearity to the
output of the network and calculates the
[cross-entropy](../api_docs/python/tf/nn/softmax_cross_entropy_with_logits.md)
between the normalized predictions and a
[1-hot encoding](../api_docs/python/tf/sparse_to_dense.md) of the label.
For regularization, we also apply the usual
[weight decay](../api_docs/python/tf/nn/l2_loss.md) losses to all learned
...
We visualize it in TensorBoard with a [`tf.summary.scalar`](../api_docs/python/tf/summary/scalar.md):
...
[exponentially decays](../api_docs/python/tf/train/exponential_decay.md)
over time.
...
`cifar10_train.py` periodically [saves](../api_docs/python/tf/train/Saver.md)
all model parameters in
[checkpoint files](../programmers_guide/variables.md#saving-and-restoring)
...
[TensorBoard](../get_started/summaries_and_tensorboard.md) provides this
...
[`tf.name_scope`](../api_docs/python/tf/name_scope.md) provides
...
[`tf.device`](../api_docs/python/tf/device.md) specifies this. For
...
See how-to on [Sharing Variables](../programmers_guide/variables.md).
