...
Defined in [`tensorflow/python/keras/_impl/keras/layers/wrappers.py`](https://www.tensorflow.org/code/tensorflow/python/keras/_impl/keras/layers/wrappers.py).
