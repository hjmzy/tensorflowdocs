...
A GRU impl akin to [`tf.nn.rnn_cell.GRUCell`](../../../tf/contrib/rnn/GRUCell.md) to use along with
[`tf.contrib.cudnn_rnn.CudnnGRU`](../../../tf/contrib/cudnn_rnn/CudnnGRU.md). The latter's params can be used by
it seamlessly.
...
Other GRU (see [`tf.nn.rnn_cell.GRUCell`](../../../tf/contrib/rnn/GRUCell.md) and [`tf.contrib.rnn.GRUBlockCell`](../../../tf/contrib/rnn/GRUBlockCell.md)):
```python
